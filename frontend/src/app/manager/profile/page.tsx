...
export default function ManagerProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <TopNavigation userRole="manager" userName={user?.name || 'Manager'} />
        ...
        <Card>
          <div className="space-y-6">
            <div className="flex items-center gap-4 pb-6 border-b border-gray-200">
              ...
              <div>
                <h2 className="text-2xl font-bold text-gray-900">{user?.name || 'Manager'}</h2>
                <p className="text-gray-600 capitalize">{user?.role || 'station_manager'}</p>
              </div>
            </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-900 font-semibold capitalize">
                    {user?.role === 'station_manager' ? 'Station Manager' : user?.role || 'N/A'}
                  </p>
                </div>
              </div>
